...
export default function DragDropZone({
  ...
  return (
    ...
    >
      <CardBody className="flex items-center justify-center p-12 text-center">
        <input {...getInputProps()} />

        <div className="space-y-4">
          {/* Upload Icon */}
          <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30">
            <svg
